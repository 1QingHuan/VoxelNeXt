# python demo.py --cfg_file cfgs/kitti_models/pv_rcnn.yaml --ckpt ./pv_rcnn_8369.pth --data_path ../data/kitti/training/velodyne
...
class DemoDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        print(f"self.ext: {self.ext}", "path: ", self.sample_file_list[index])
        if self.ext == '.bin':
