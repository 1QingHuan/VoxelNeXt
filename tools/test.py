# To evaluate the nuScenes by model voxelnext_nuscenes_kernel1.pth, run the following command:
# cd tools
...
# To evaluate the KITTI dataset by model pv_rcnn_8369.pth, run the following command:
# cd tools
...
def parse_config():
    ...
    parser.add_argument('--local-rank', type=int, default=0, help='Local rank of the process on the current machine')
